	...
	return (
		<MainTemplate>
          ...
          bgColor='red'
					...
					py={{ base: 9 }}
					px={{ base: 4 }}>
					<Grid color='white' maxW={'8xl'} mx='auto' templateColumns='300px 1fr 1fr' gap={10}>
						<GridItem rowSpan={2}>
							<Image src={`https://image.tmdb.org/t/p/w500/${movie.poster_path}`} alt='Dan Abramov' borderRadius={8} />
						</GridItem>
						...
						<GridItem colSpan={1}>
							...
							<Flex mt='30px' align='center' size='100px' gap={3}>
								<CircularProgress
									...
									color='blue.400'
									size='60px'>
									<CircularProgressLabel color='white' fontWeight={700} fontSize={18}>
